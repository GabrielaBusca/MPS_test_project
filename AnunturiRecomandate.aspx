<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AnunturiRecomandate.aspx.cs" Inherits="AnunturiRecomandate" %>
...
<td><article>
    <a href="VeziAnunt?id=<%#Eval("id")%>"><strong><%#Eval("titlu")%></strong></a> adăugat de <a href="profile?user=<%#Eval("username") %>"><%#Eval("username") %></a> pe <%#Eval("data")%> în <%#Eval("denumire") %>
</article></td>
</tr></ItemTemplate>
        <FooterTemplate>
        </tbody></table>
