<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AnunturiPrieteni.aspx.cs" Inherits="AnunturiPrieteni" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
        <h2>Anunțurile prietenilor</h2>
...
<td><article>
   ...
   <div runat="server" visible="<%# Repeater1.Items.Count == 0%>"><h4 style="margin-left: 10px">Nu este disponibil niciun anunț!</h4></div>
