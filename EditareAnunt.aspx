<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EditareAnunt.aspx.cs" Inherits="EditareAnunt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="form">
        ...
        <div class="col-xs-10"><asp:TextBox ID="titlu" CssClass="form-control" runat="server" MaxLength="50"></asp:TextBox></div>
           ...
           <span style="color: red; font-weight: bold"><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Câmp obligatoriu" ControlToValidate="titlu" Display="Dynamic"></asp:RequiredFieldValidator></span>
