<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AnunturiUrmarite.aspx.cs" Inherits="AnunturiUrmarite" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
        <h2>Anunțurile pe care le urmăresc</h2>
...
<td><article>
   ...
   <div runat="server" visible="<%# Repeater1.Items.Count == 0%>"><h4 style="margin-left: 10px">Nu urmărești niciun anunț!</h4></div>
